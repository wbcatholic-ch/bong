...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-6',
  './css/cover-modals.css?v=V4-6',
  './css/myfaith.css?v=V4-6',
  './js/myfaith.js?v=V4-6',
  './app.js?v=V4-6',
  './web.js?v=V4-6',
  './patches.js?v=V4-6',
  './sw-update.js?v=V4-6',
  './manifest.json?v=V4-6',
  './icon-192x192.png?v=V4-6',
  './icon-512x512.png?v=V4-6',
  './icon-512x512-maskable.png?v=V4-6',
];
