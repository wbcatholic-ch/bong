...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-53',
  './css/module-common.css?v=V4-53',
  './css/prayer.css?v=V4-53',
  './css/web.css?v=V4-53',
  './css/pilgrimage.css?v=V4-53',
  './css/overlays.css?v=V4-53',
  './css/cover-modals.css?v=V4-53',
  './css/myfaith.css?v=V4-53',
  './css/my-diocese.css?v=V4-53',
  './js/myfaith.js?v=V4-53',
  './app.js?v=V4-53',
  './js/cover-common.js?v=V4-53',
  './js/touch-ux.js?v=V4-53',
  './js/prayer-ui.js?v=V4-53',
  './js/cover-refresh.js?v=V4-53',
  './js/app-state-guards.js?v=V4-53',
  './web.js?v=V4-53',
  './js/route-web-guards.js?v=V4-53',
  './js/prayer-back.js?v=V4-53',
  './js/back-controller.js?v=V4-53',
  './sw-update.js?v=V4-53',
  './manifest.json?v=V4-53',
  './icon-192x192.png?v=V4-53',
  './icon-512x512.png?v=V4-53',
  './icon-512x512-maskable.png?v=V4-53',
];
