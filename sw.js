...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-49',
  './css/module-common.css?v=V4-49',
  './css/prayer.css?v=V4-49',
  './css/web.css?v=V4-49',
  './css/pilgrimage.css?v=V4-49',
  './css/overlays.css?v=V4-49',
  './css/cover-modals.css?v=V4-49',
  './css/myfaith.css?v=V4-49',
  './css/my-diocese.css?v=V4-49',
  './js/myfaith.js?v=V4-49',
  './app.js?v=V4-49',
  './js/cover-common.js?v=V4-49',
  './js/touch-ux.js?v=V4-49',
  './js/prayer-ui.js?v=V4-49',
  './js/cover-refresh.js?v=V4-49',
  './js/app-state-guards.js?v=V4-49',
  './web.js?v=V4-49',
  './js/route-web-guards.js?v=V4-49',
  './js/prayer-back.js?v=V4-49',
  './js/back-controller.js?v=V4-49',
  './sw-update.js?v=V4-49',
  './manifest.json?v=V4-49',
  './icon-192x192.png?v=V4-49',
  './icon-512x512.png?v=V4-49',
  './icon-512x512-maskable.png?v=V4-49',
];
