...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-54',
  './css/module-common.css?v=V4-54',
  './css/prayer.css?v=V4-54',
  './css/web.css?v=V4-54',
  './css/pilgrimage.css?v=V4-54',
  './css/overlays.css?v=V4-54',
  './css/cover-modals.css?v=V4-54',
  './css/myfaith.css?v=V4-54',
  './css/my-diocese.css?v=V4-54',
  './js/myfaith.js?v=V4-54',
  './app.js?v=V4-54',
  './js/cover-common.js?v=V4-54',
  './js/touch-ux.js?v=V4-54',
  './js/prayer-ui.js?v=V4-54',
  './js/cover-refresh.js?v=V4-54',
  './js/app-state-guards.js?v=V4-54',
  './web.js?v=V4-54',
  './js/route-web-guards.js?v=V4-54',
  './js/prayer-back.js?v=V4-54',
  './js/back-controller.js?v=V4-54',
  './sw-update.js?v=V4-54',
  './manifest.json?v=V4-54',
  './icon-192x192.png?v=V4-54',
  './icon-512x512.png?v=V4-54',
  './icon-512x512-maskable.png?v=V4-54',
];
