...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-36',
  './css/module-common.css?v=V4-36',
  './css/prayer.css?v=V4-36',
  './css/web.css?v=V4-36',
  './css/pilgrimage.css?v=V4-36',
  './css/overlays.css?v=V4-36',
  './css/cover-modals.css?v=V4-36',
  './css/myfaith.css?v=V4-36',
  './css/my-diocese.css?v=V4-36',
  './js/myfaith.js?v=V4-36',
  './app.js?v=V4-36',
  './js/cover-common.js?v=V4-36',
  './js/touch-ux.js?v=V4-36',
  './js/prayer-ui.js?v=V4-36',
  './js/cover-refresh.js?v=V4-36',
  './js/app-state-guards.js?v=V4-36',
  './web.js?v=V4-36',
  './js/route-web-guards.js?v=V4-36',
  './js/prayer-back.js?v=V4-36',
  './js/back-controller.js?v=V4-36',
  './sw-update.js?v=V4-36',
  './manifest.json?v=V4-36',
  './icon-192x192.png?v=V4-36',
  './icon-512x512.png?v=V4-36',
  './icon-512x512-maskable.png?v=V4-36',
];
