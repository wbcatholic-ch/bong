...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-45',
  './css/module-common.css?v=V4-45',
  './css/prayer.css?v=V4-45',
  './css/web.css?v=V4-45',
  './css/pilgrimage.css?v=V4-45',
  './css/overlays.css?v=V4-45',
  './css/cover-modals.css?v=V4-45',
  './css/myfaith.css?v=V4-45',
  './css/my-diocese.css?v=V4-45',
  './js/myfaith.js?v=V4-45',
  './app.js?v=V4-45',
  './js/cover-common.js?v=V4-45',
  './js/touch-ux.js?v=V4-45',
  './js/prayer-ui.js?v=V4-45',
  './js/cover-refresh.js?v=V4-45',
  './js/app-state-guards.js?v=V4-45',
  './web.js?v=V4-45',
  './js/route-web-guards.js?v=V4-45',
  './js/prayer-back.js?v=V4-45',
  './js/back-controller.js?v=V4-45',
  './sw-update.js?v=V4-45',
  './manifest.json?v=V4-45',
  './icon-192x192.png?v=V4-45',
  './icon-512x512.png?v=V4-45',
  './icon-512x512-maskable.png?v=V4-45',
];
