...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-63',
  './css/module-common.css?v=V4-63',
  './css/prayer.css?v=V4-63',
  './css/web.css?v=V4-63',
  './css/pilgrimage.css?v=V4-63',
  './css/overlays.css?v=V4-63',
  './css/cover-modals.css?v=V4-63',
  './css/myfaith.css?v=V4-63',
  './css/my-diocese.css?v=V4-63',
  './js/myfaith.js?v=V4-63',
  './app.js?v=V4-63',
  './js/cover-common.js?v=V4-63',
  './js/touch-ux.js?v=V4-63',
  './js/prayer-ui.js?v=V4-63',
  './js/cover-refresh.js?v=V4-63',
  './js/app-state-guards.js?v=V4-63',
  './web.js?v=V4-63',
  './js/route-web-guards.js?v=V4-63',
  './js/prayer-back.js?v=V4-63',
  './js/back-controller.js?v=V4-63',
  './sw-update.js?v=V4-63',
  './manifest.json?v=V4-63',
  './icon-192x192.png?v=V4-63',
  './icon-512x512.png?v=V4-63',
  './icon-512x512-maskable.png?v=V4-63',
];
