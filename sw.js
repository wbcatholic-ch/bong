...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-8',
  './css/cover-modals.css?v=V4-8',
  './css/myfaith.css?v=V4-8',
  './js/myfaith.js?v=V4-8',
  './app.js?v=V4-8',
  './js/cover-common.js?v=V4-8',
  './web.js?v=V4-8',
  './patches.js?v=V4-8',
  './sw-update.js?v=V4-8',
  './manifest.json?v=V4-8',
  './icon-192x192.png?v=V4-8',
  './icon-512x512.png?v=V4-8',
  './icon-512x512-maskable.png?v=V4-8',
];
