...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-38',
  './css/module-common.css?v=V4-38',
  './css/prayer.css?v=V4-38',
  './css/web.css?v=V4-38',
  './css/pilgrimage.css?v=V4-38',
  './css/overlays.css?v=V4-38',
  './css/cover-modals.css?v=V4-38',
  './css/myfaith.css?v=V4-38',
  './css/my-diocese.css?v=V4-38',
  './js/myfaith.js?v=V4-38',
  './app.js?v=V4-38',
  './js/cover-common.js?v=V4-38',
  './js/touch-ux.js?v=V4-38',
  './js/prayer-ui.js?v=V4-38',
  './js/cover-refresh.js?v=V4-38',
  './js/app-state-guards.js?v=V4-38',
  './web.js?v=V4-38',
  './js/route-web-guards.js?v=V4-38',
  './js/prayer-back.js?v=V4-38',
  './js/back-controller.js?v=V4-38',
  './sw-update.js?v=V4-38',
  './manifest.json?v=V4-38',
  './icon-192x192.png?v=V4-38',
  './icon-512x512.png?v=V4-38',
  './icon-512x512-maskable.png?v=V4-38',
];
