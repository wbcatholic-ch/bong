...
const APP_SHELL = [
  ...
  './patches.js?v=V4-2',
  './sw-update.js?v=V4-2',
  './manifest.json?v=V4-2',
  './icon-192x192.png?v=V4-2',
  './icon-512x512.png?v=V4-2',
  './icon-512x512-maskable.png?v=V4-2',
];
