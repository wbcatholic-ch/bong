...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-33',
  './css/module-common.css?v=V4-33',
  './css/prayer.css?v=V4-33',
  './css/web.css?v=V4-33',
  './css/pilgrimage.css?v=V4-33',
  './css/overlays.css?v=V4-33',
  './css/cover-modals.css?v=V4-33',
  './css/myfaith.css?v=V4-33',
  './css/my-diocese.css?v=V4-33',
  './js/myfaith.js?v=V4-33',
  './app.js?v=V4-33',
  './js/cover-common.js?v=V4-33',
  './js/touch-ux.js?v=V4-33',
  './js/prayer-ui.js?v=V4-33',
  './js/cover-refresh.js?v=V4-33',
  './js/app-state-guards.js?v=V4-33',
  './web.js?v=V4-33',
  './js/route-web-guards.js?v=V4-33',
  './js/prayer-back.js?v=V4-33',
  './js/back-controller.js?v=V4-33',
  './sw-update.js?v=V4-33',
  './manifest.json?v=V4-33',
  './icon-192x192.png?v=V4-33',
  './icon-512x512.png?v=V4-33',
  './icon-512x512-maskable.png?v=V4-33',
];
