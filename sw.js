...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-11',
  './css/cover-modals.css?v=V4-11',
  './css/myfaith.css?v=V4-11',
  './js/myfaith.js?v=V4-11',
  './app.js?v=V4-11',
  './js/cover-common.js?v=V4-11',
  './js/touch-ux.js?v=V4-11',
  './js/prayer-ui.js?v=V4-11',
  './js/cover-refresh.js?v=V4-11',
  './web.js?v=V4-11',
  './patches.js?v=V4-11',
  './sw-update.js?v=V4-11',
  './manifest.json?v=V4-11',
  './icon-192x192.png?v=V4-11',
  './icon-512x512.png?v=V4-11',
  './icon-512x512-maskable.png?v=V4-11',
];
...
function isVersionedAsset(request) {
  try {
    ...
    return url.searchParams.has('v') ||
      /parishes(?:-[a-z-]+)?\.js|prayer\.js|retreats\.js|shrines\.js|diocese\.html|qa-firebase\.html|app\.js|style\.css|web\.js|patches\.js|touch-ux\.js|prayer-ui\.js|cover-refresh\.js|sw-update\.js/.test(url.pathname);
