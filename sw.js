...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-56',
  './css/module-common.css?v=V4-56',
  './css/prayer.css?v=V4-56',
  './css/web.css?v=V4-56',
  './css/pilgrimage.css?v=V4-56',
  './css/overlays.css?v=V4-56',
  './css/cover-modals.css?v=V4-56',
  './css/myfaith.css?v=V4-56',
  './css/my-diocese.css?v=V4-56',
  './js/myfaith.js?v=V4-56',
  './app.js?v=V4-56',
  './js/cover-common.js?v=V4-56',
  './js/touch-ux.js?v=V4-56',
  './js/prayer-ui.js?v=V4-56',
  './js/cover-refresh.js?v=V4-56',
  './js/app-state-guards.js?v=V4-56',
  './web.js?v=V4-56',
  './js/route-web-guards.js?v=V4-56',
  './js/prayer-back.js?v=V4-56',
  './js/back-controller.js?v=V4-56',
  './sw-update.js?v=V4-56',
  './manifest.json?v=V4-56',
  './icon-192x192.png?v=V4-56',
  './icon-512x512.png?v=V4-56',
  './icon-512x512-maskable.png?v=V4-56',
];
