const CACHE_VERSION = 'catholic-way-V8-1-14-DELETE-OLD-BACK-BASE-CHECK';
const ASSET_VERSION = 'V8-1-14-DELETE-OLD-BACK-BASE-CHECK';
...
function isVersionedAsset(request) {
  try {
    ...
    return url.searchParams.has('v') ||
      /parishes-[a-z-]+\.js|prayer-data\.js|prayer\.js|retreats\.js|shrines\.js|diocese\.html|diocese\.css|qa-firebase\.html|app\.js|style\.css|module-common\.css|prayer\.css|web\.css|pilgrimage\.css|overlays\.css|cover-modals\.css|myfaith\.css|my-diocese\.css|web\.js|touch-ux\.js|prayer-ui\.js|cover-refresh\.js|app-state-guards\.js|route-web-guards\.js|sw-update\.js/.test(url.pathname);
