...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-62',
  './css/module-common.css?v=V4-62',
  './css/prayer.css?v=V4-62',
  './css/web.css?v=V4-62',
  './css/pilgrimage.css?v=V4-62',
  './css/overlays.css?v=V4-62',
  './css/cover-modals.css?v=V4-62',
  './css/myfaith.css?v=V4-62',
  './css/my-diocese.css?v=V4-62',
  './js/myfaith.js?v=V4-62',
  './app.js?v=V4-62',
  './js/cover-common.js?v=V4-62',
  './js/touch-ux.js?v=V4-62',
  './js/prayer-ui.js?v=V4-62',
  './js/cover-refresh.js?v=V4-62',
  './js/app-state-guards.js?v=V4-62',
  './web.js?v=V4-62',
  './js/route-web-guards.js?v=V4-62',
  './js/prayer-back.js?v=V4-62',
  './js/back-controller.js?v=V4-62',
  './sw-update.js?v=V4-62',
  './manifest.json?v=V4-62',
  './icon-192x192.png?v=V4-62',
  './icon-512x512.png?v=V4-62',
  './icon-512x512-maskable.png?v=V4-62',
];
