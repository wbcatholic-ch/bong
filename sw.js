...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-5',
  './css/myfaith.css?v=V4-5',
  './js/myfaith.js?v=V4-5',
  './app.js?v=V4-5',
  './web.js?v=V4-5',
  './patches.js?v=V4-5',
  './sw-update.js?v=V4-5',
  './manifest.json?v=V4-5',
  './icon-192x192.png?v=V4-5',
  './icon-512x512.png?v=V4-5',
  './icon-512x512-maskable.png?v=V4-5',
];
