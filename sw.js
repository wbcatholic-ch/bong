...
const APP_SHELL = [
  ...
  './patches.js?v=V4-3',
  './sw-update.js?v=V4-3',
  './manifest.json?v=V4-3',
  './icon-192x192.png?v=V4-3',
  './icon-512x512.png?v=V4-3',
  './icon-512x512-maskable.png?v=V4-3',
];
