...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-46',
  './css/module-common.css?v=V4-46',
  './css/prayer.css?v=V4-46',
  './css/web.css?v=V4-46',
  './css/pilgrimage.css?v=V4-46',
  './css/overlays.css?v=V4-46',
  './css/cover-modals.css?v=V4-46',
  './css/myfaith.css?v=V4-46',
  './css/my-diocese.css?v=V4-46',
  './js/myfaith.js?v=V4-46',
  './app.js?v=V4-46',
  './js/cover-common.js?v=V4-46',
  './js/touch-ux.js?v=V4-46',
  './js/prayer-ui.js?v=V4-46',
  './js/cover-refresh.js?v=V4-46',
  './js/app-state-guards.js?v=V4-46',
  './web.js?v=V4-46',
  './js/route-web-guards.js?v=V4-46',
  './js/prayer-back.js?v=V4-46',
  './js/back-controller.js?v=V4-46',
  './sw-update.js?v=V4-46',
  './manifest.json?v=V4-46',
  './icon-192x192.png?v=V4-46',
  './icon-512x512.png?v=V4-46',
  './icon-512x512-maskable.png?v=V4-46',
];
