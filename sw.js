...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-66',
  './css/module-common.css?v=V4-66',
  './css/prayer.css?v=V4-66',
  './css/web.css?v=V4-66',
  './css/pilgrimage.css?v=V4-66',
  './css/overlays.css?v=V4-66',
  './css/cover-modals.css?v=V4-66',
  './css/myfaith.css?v=V4-66',
  './css/my-diocese.css?v=V4-66',
  './js/myfaith.js?v=V4-66',
  './app.js?v=V4-66',
  './js/cover-common.js?v=V4-66',
  './js/touch-ux.js?v=V4-66',
  './js/prayer-ui.js?v=V4-66',
  './js/cover-refresh.js?v=V4-66',
  './js/app-state-guards.js?v=V4-66',
  './web.js?v=V4-66',
  './js/route-web-guards.js?v=V4-66',
  './js/prayer-back.js?v=V4-66',
  './js/back-controller.js?v=V4-66',
  './sw-update.js?v=V4-66',
  './manifest.json?v=V4-66',
  './icon-192x192.png?v=V4-66',
  './icon-512x512.png?v=V4-66',
  './icon-512x512-maskable.png?v=V4-66',
];
