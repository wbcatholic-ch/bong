...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-59',
  './css/module-common.css?v=V4-59',
  './css/prayer.css?v=V4-59',
  './css/web.css?v=V4-59',
  './css/pilgrimage.css?v=V4-59',
  './css/overlays.css?v=V4-59',
  './css/cover-modals.css?v=V4-59',
  './css/myfaith.css?v=V4-59',
  './css/my-diocese.css?v=V4-59',
  './js/myfaith.js?v=V4-59',
  './app.js?v=V4-59',
  './js/cover-common.js?v=V4-59',
  './js/touch-ux.js?v=V4-59',
  './js/prayer-ui.js?v=V4-59',
  './js/cover-refresh.js?v=V4-59',
  './js/app-state-guards.js?v=V4-59',
  './web.js?v=V4-59',
  './js/route-web-guards.js?v=V4-59',
  './js/prayer-back.js?v=V4-59',
  './js/back-controller.js?v=V4-59',
  './sw-update.js?v=V4-59',
  './manifest.json?v=V4-59',
  './icon-192x192.png?v=V4-59',
  './icon-512x512.png?v=V4-59',
  './icon-512x512-maskable.png?v=V4-59',
];
