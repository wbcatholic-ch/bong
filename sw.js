...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-61',
  './css/module-common.css?v=V4-61',
  './css/prayer.css?v=V4-61',
  './css/web.css?v=V4-61',
  './css/pilgrimage.css?v=V4-61',
  './css/overlays.css?v=V4-61',
  './css/cover-modals.css?v=V4-61',
  './css/myfaith.css?v=V4-61',
  './css/my-diocese.css?v=V4-61',
  './js/myfaith.js?v=V4-61',
  './app.js?v=V4-61',
  './js/cover-common.js?v=V4-61',
  './js/touch-ux.js?v=V4-61',
  './js/prayer-ui.js?v=V4-61',
  './js/cover-refresh.js?v=V4-61',
  './js/app-state-guards.js?v=V4-61',
  './web.js?v=V4-61',
  './js/route-web-guards.js?v=V4-61',
  './js/prayer-back.js?v=V4-61',
  './js/back-controller.js?v=V4-61',
  './sw-update.js?v=V4-61',
  './manifest.json?v=V4-61',
  './icon-192x192.png?v=V4-61',
  './icon-512x512.png?v=V4-61',
  './icon-512x512-maskable.png?v=V4-61',
];
