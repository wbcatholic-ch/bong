...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-48',
  './css/module-common.css?v=V4-48',
  './css/prayer.css?v=V4-48',
  './css/web.css?v=V4-48',
  './css/pilgrimage.css?v=V4-48',
  './css/overlays.css?v=V4-48',
  './css/cover-modals.css?v=V4-48',
  './css/myfaith.css?v=V4-48',
  './css/my-diocese.css?v=V4-48',
  './js/myfaith.js?v=V4-48',
  './app.js?v=V4-48',
  './js/cover-common.js?v=V4-48',
  './js/touch-ux.js?v=V4-48',
  './js/prayer-ui.js?v=V4-48',
  './js/cover-refresh.js?v=V4-48',
  './js/app-state-guards.js?v=V4-48',
  './web.js?v=V4-48',
  './js/route-web-guards.js?v=V4-48',
  './js/prayer-back.js?v=V4-48',
  './js/back-controller.js?v=V4-48',
  './sw-update.js?v=V4-48',
  './manifest.json?v=V4-48',
  './icon-192x192.png?v=V4-48',
  './icon-512x512.png?v=V4-48',
  './icon-512x512-maskable.png?v=V4-48',
];
