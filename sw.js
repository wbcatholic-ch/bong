...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-55',
  './css/module-common.css?v=V4-55',
  './css/prayer.css?v=V4-55',
  './css/web.css?v=V4-55',
  './css/pilgrimage.css?v=V4-55',
  './css/overlays.css?v=V4-55',
  './css/cover-modals.css?v=V4-55',
  './css/myfaith.css?v=V4-55',
  './css/my-diocese.css?v=V4-55',
  './js/myfaith.js?v=V4-55',
  './app.js?v=V4-55',
  './js/cover-common.js?v=V4-55',
  './js/touch-ux.js?v=V4-55',
  './js/prayer-ui.js?v=V4-55',
  './js/cover-refresh.js?v=V4-55',
  './js/app-state-guards.js?v=V4-55',
  './web.js?v=V4-55',
  './js/route-web-guards.js?v=V4-55',
  './js/prayer-back.js?v=V4-55',
  './js/back-controller.js?v=V4-55',
  './sw-update.js?v=V4-55',
  './manifest.json?v=V4-55',
  './icon-192x192.png?v=V4-55',
  './icon-512x512.png?v=V4-55',
  './icon-512x512-maskable.png?v=V4-55',
];
