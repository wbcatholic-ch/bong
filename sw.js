...
const APP_SHELL = [
  ...
  './index.html',
  './style.css?v=V4-52',
  './css/module-common.css?v=V4-52',
  './css/prayer.css?v=V4-52',
  './css/web.css?v=V4-52',
  './css/pilgrimage.css?v=V4-52',
  './css/overlays.css?v=V4-52',
  './css/cover-modals.css?v=V4-52',
  './css/myfaith.css?v=V4-52',
  './css/my-diocese.css?v=V4-52',
  './js/myfaith.js?v=V4-52',
  './app.js?v=V4-52',
  './js/cover-common.js?v=V4-52',
  './js/touch-ux.js?v=V4-52',
  './js/prayer-ui.js?v=V4-52',
  './js/cover-refresh.js?v=V4-52',
  './js/app-state-guards.js?v=V4-52',
  './web.js?v=V4-52',
  './js/route-web-guards.js?v=V4-52',
  './js/prayer-back.js?v=V4-52',
  './js/back-controller.js?v=V4-52',
  './sw-update.js?v=V4-52',
  './manifest.json?v=V4-52',
  './icon-192x192.png?v=V4-52',
  './icon-512x512.png?v=V4-52',
  './icon-512x512-maskable.png?v=V4-52',
];
