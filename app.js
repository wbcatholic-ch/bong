...
function _resetCoverBackTrap(reason){
  /* V4-36: 커버 trap 재설정도 js/back-controller.js의 공통 armCoverBackTrap을 우선 사용한다.
...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V4-36';
  }else if(!restore){
...
const _PARISH_ASSET_VERSION='V4-36';
...
const _PRAYER_ASSET_VERSION='V4-36';
...
const _RETREAT_ASSET_VERSION='V4-36';
...
const _SHRINE_ASSET_VERSION='V4-36';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
