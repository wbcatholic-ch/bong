...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V6-73';
...
const _PARISH_ASSET_VERSION='V6-73';
...
const _PRAYER_ASSET_VERSION='V6-73';
...
const _RETREAT_ASSET_VERSION='V6-73';
...
const _SHRINE_ASSET_VERSION='V6-73';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
