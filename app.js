...
function _resetCoverBackTrap(reason){
  /* V4-74: 커버 trap 재설정도 js/back-controller.js의 공통 armCoverBackTrap을 우선 사용한다.
...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V4-74';
  }else if(!restore){
...
function closeDioceseView(){
  ...
  /*
     V4-74: 관구·교구는 커버에서 여는 독립 iframe 화면이므로,
...
const _PARISH_ASSET_VERSION='V4-74';
...
const _PRAYER_ASSET_VERSION='V4-74';
...
const _RETREAT_ASSET_VERSION='V4-74';
...
const _SHRINE_ASSET_VERSION='V4-74';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
