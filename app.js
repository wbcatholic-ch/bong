...
/* V8-1-13-5: 성지 카테고리 전용 뒤로가기 순서표 + back trap 재무장
...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V8-1-13-5-SHRINE-BACK-REARM';
...
const _PRAYER_ASSET_VERSION='V8-1-13-5-SHRINE-BACK-REARM';
