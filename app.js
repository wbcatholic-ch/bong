...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V4-88';
  }else if(!restore){
...
const _PARISH_ASSET_VERSION='V4-88';
...
const _PRAYER_ASSET_VERSION='V4-88';
...
const _RETREAT_ASSET_VERSION='V4-88';
...
const _SHRINE_ASSET_VERSION='V4-88';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
