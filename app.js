...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V6-61';
...
const _PARISH_ASSET_VERSION='V6-61';
...
const _PRAYER_ASSET_VERSION='V6-61';
...
const _RETREAT_ASSET_VERSION='V6-61';
...
const _SHRINE_ASSET_VERSION='V6-61';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
