...
function _forceCoverAfterPrayerQuickPopup(){
  ...
  try{
    ...
    _resetCoverExitReady();
    _clearCoverExitArmed();
    // 기도문 팝업에서 커버로 온 직후에는 커버 첫 Back이 반드시 안내여야 한다.
    // 이전 팝업/기도문 흐름에서 남은 종료 armed 값이 있어도 첫 Back 때 한 번 더 정리하도록 표시한다.
